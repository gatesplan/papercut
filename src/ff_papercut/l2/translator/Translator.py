...
SYSTEM_PROMPT = (
    ...
    "2. 수식(LaTeX), 코드 블록, 이미지 경로는 번역하지 않고 원형 유지한다.\n"
    "3. 고유명사(물질명, 학술용어 등)는 번역어 뒤에 원어를 괄호로 병기한다. 예: olivine -> 감람석(olivine)\n"
    "4. 원어가 영어가 아닌 용어는 발음도 함께 병기한다. 예: 원어(원어표기;발음)\n"
    "5. 번역 결과만 출력한다. 설명이나 주석을 덧붙이지 않는다."
)
